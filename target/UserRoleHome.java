...
public class UserRoleHome {
	...
	public UserRole findById(java.lang.Integer id) {
		...
		try {
			UserRole instance = (UserRole) sessionFactory.getCurrentSession().get("UserRole", id);
			if (instance == null) {
	...
	public List<UserRole> findByExample(UserRole instance) {
		...
		try {
			List<UserRole> results = (List<UserRole>) sessionFactory.getCurrentSession().createCriteria("UserRole")
